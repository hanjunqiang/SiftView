...
@implementation UIImage (SiftExtension)
 ...
 *  箭头图标
 */
+(instancetype)imageArrowWithSize:(CGSize)size lineWidth:(CGFloat)lineWidth andColor:(UIColor *)arrowColor andArrowDirection:(NSInteger)direction stroke:(BOOL)stroke
{
    UIGraphicsBeginImageContextWithOptions(size, 0, 2);
